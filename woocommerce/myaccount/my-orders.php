...
<table class="shop_table my_account_orders">
	<thead>
		<tr>
			...
			<th class="order-date"><span class="nobr"><?php _e( 'Date', 'academy' ); ?></span></th>
			<th class="order-status"><span class="nobr"><?php _e( 'Status', 'academy' ); ?></span></th>
			<th class="order-total"><span class="nobr"><?php _e( 'Total', 'academy' ); ?></span></th>
		</tr>
	</thead>
	<tbody>
	<?php
