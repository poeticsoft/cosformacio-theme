...
$product=reset(WC()->cart->get_cart());
...
?>
<form name="checkout" method="post" class="checkout woocommerce-checkout course-checkout" action="<?php echo esc_url($get_checkout_url); ?>">
