...
<div class="column fourcol">
	...
	<form action="<?php echo themex_url(); ?>" class="formatted-form" method="POST">
		...
		<?php if(!ThemexCore::checkOption('profile_description')) { ?>
			<div class="profile-description-label"><?php echo __('Profile Text [ES]', 'academy'); ?></div>
			<?php ThemexInterface::renderEditor('ca_description', ThemexUser::$data['user']['profile']['ca_description']); ?>
			<div class="profile-description-label"><?php echo __('Profile Text [CA]', 'academy'); ?></div>
