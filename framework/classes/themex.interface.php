...
class ThemexInterface {
	...
	public static function renderCommentForm($args) {
		...
		if(is_singular('lesson')) {
			...
			$args['comment_field'].='<div class="field-wrapper"><textarea id="comment" name="comment" cols="45" rows="8" placeholder="'.__('Comment', 'academy').'" required="required"></textarea></div></div>';
			...
			$args['fields']['author']='<div class="field-wrapper"><input id="author" name="author" type="text" value="" size="30" placeholder="'.__('Name', 'academy').'" required="required" /></div>';
			$args['fields']['email']='<div class="field-wrapper"><input id="email" name="email" type="text" value="" size="30" placeholder="'.__('Email', 'academy').'" required="required" /></div>';
			$args['fields']['url']='';
			$args['comment_field']='<div class="field-wrapper"><textarea id="comment" name="comment" cols="45" rows="8" placeholder="'.__('Comment', 'academy').'" required="required"></textarea></div>';
			$args['label_submit']=__('Add Comment', 'academy');
		}
		
		$args['title_reply']='';
		$args['title_reply_to']='';
		$args['cancel_reply_link']=__('Cancel Reply', 'academy');
	...
	public static function renderPageTitle() {
		...
		} else if($wp->request == 'register') {

			$out=__('Registration', 'academy');
		}
